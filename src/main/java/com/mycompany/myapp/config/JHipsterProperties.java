...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "AngularSpringGulpApp@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "AngularSpringGulpApp API";

        private String description = "AngularSpringGulpApp API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "AngularSpringGulpApp";
